...
extension HomeVC: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        if containerGeneratedTypes[indexPath.row] == "Text" {
            ...
            return cell
        } else if containerGeneratedTypes[indexPath.row] == "Text+ThreePhotos" {
            let cell = Bundle.main.loadNibNamed("TextThreePhotosTableViewCell",
                                                owner: self,
                                                options: nil)?.first as! TextThreePhotosTableViewCell
            cell.imageTopContainer.image = #imageLiteral(resourceName: "icTestImage1")
            if #imageLiteral(resourceName: "icTestImage1").size.height > #imageLiteral(resourceName: "icTestImage1").size.width {
                cell.heightMiddleView.constant = isVerticalImageHeight + UIScreen.main.bounds.size.width / 2 + 77
                cell.heightTopContainer.constant = isVerticalImageHeight
            } else if #imageLiteral(resourceName: "icTestImage1").size.height < #imageLiteral(resourceName: "icTestImage1").size.width {
                cell.heightMiddleView.constant = isHorizontalImageHeight + UIScreen.main.bounds.size.width / 2 + 77
                cell.heightTopContainer.constant = isHorizontalImageHeight
            } else {
                cell.heightMiddleView.constant = UIScreen.main.bounds.size.width + UIScreen.main.bounds.size.width / 2 + 77
                cell.heightTopContainer.constant = UIScreen.main.bounds.size.width
            }
            cell.heightLeftContainer.constant = UIScreen.main.bounds.size.width / 2 - 1
            cell.heightRightContainer.constant = UIScreen.main.bounds.size.width / 2 - 1
    ...
    func tableView(_ tableView: UITableView, heightForRowAt indexPath: IndexPath) -> CGFloat {
        if containerGeneratedTypes[indexPath.row] == "Text" {
            ...
            if #imageLiteral(resourceName: "icTestImage1").size.height > #imageLiteral(resourceName: "icTestImage1").size.width {
                return isVerticalImageHeight + UIScreen.main.bounds.size.width / 2 + 209
            } else if #imageLiteral(resourceName: "icTestImage1").size.height < #imageLiteral(resourceName: "icTestImage1").size.width {
                return isHorizontalImageHeight + UIScreen.main.bounds.size.width / 2 + 209
            } else {
                return UIScreen.main.bounds.size.width + UIScreen.main.bounds.size.width / 2 + 209
            }
        } else {
            return 10
        }
